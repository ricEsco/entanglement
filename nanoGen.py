...
def process_event(entry, histograms):
    ...
    ### Slow region ###
    if beta < 0.9 and m_tt < 390:
        histograms['h_lb_cHel_slow'].Fill(lb_cHel)
        histograms['h_lb_cHel_P3n_slow'].Fill(lb_cHel_P3n)
        histograms['h_ld_cHel_slow'].Fill(ld_cHel)
        histograms['h_ld_cHel_P3n_slow'].Fill(ld_cHel_P3n)
        histograms['h_lb_Cnn_slow'].Fill(lb_Cnn)
        histograms['h_lb_Cnr_slow'].Fill(lb_Cnr)
        histograms['h_lb_Cnk_slow'].Fill(lb_Cnk)
        histograms['h_lb_Crn_slow'].Fill(lb_Crn)
        histograms['h_lb_Crr_slow'].Fill(lb_Crr)
        histograms['h_lb_Crk_slow'].Fill(lb_Crk)
        histograms['h_lb_Ckn_slow'].Fill(lb_Ckn)
        histograms['h_lb_Ckr_slow'].Fill(lb_Ckr)
        histograms['h_lb_Ckk_slow'].Fill(lb_Ckk)
        histograms['h_ld_Cnn_slow'].Fill(ld_Cnn)
        histograms['h_ld_Cnr_slow'].Fill(ld_Cnr)
        histograms['h_ld_Cnk_slow'].Fill(ld_Cnk)
        histograms['h_ld_Crn_slow'].Fill(ld_Crn)
        histograms['h_ld_Crr_slow'].Fill(ld_Crr)
        histograms['h_ld_Crk_slow'].Fill(ld_Crk)
        histograms['h_ld_Ckn_slow'].Fill(ld_Ckn)
        histograms['h_ld_Ckr_slow'].Fill(ld_Ckr)
        histograms['h_ld_Ckk_slow'].Fill(ld_Ckk)
    ### BoostedCentral region ###
    if abs(scattering_angle) < 0.6 and m_tt > 800:
        histograms['h_lb_cHel_BoostedCentral'].Fill(lb_cHel)
        histograms['h_lb_cHel_P3n_BoostedCentral'].Fill(lb_cHel_P3n)
        histograms['h_ld_cHel_BoostedCentral'].Fill(ld_cHel)
        histograms['h_ld_cHel_P3n_BoostedCentral'].Fill(ld_cHel_P3n)
        histograms['h_lb_Cnn_BoostedCentral'].Fill(lb_Cnn)
        histograms['h_lb_Cnr_BoostedCentral'].Fill(lb_Cnr)
        histograms['h_lb_Cnk_BoostedCentral'].Fill(lb_Cnk)
        histograms['h_lb_Crn_BoostedCentral'].Fill(lb_Crn)
        histograms['h_lb_Crr_BoostedCentral'].Fill(lb_Crr)
        histograms['h_lb_Crk_BoostedCentral'].Fill(lb_Crk)
        histograms['h_lb_Ckn_BoostedCentral'].Fill(lb_Ckn)
        histograms['h_lb_Ckr_BoostedCentral'].Fill(lb_Ckr)
        histograms['h_lb_Ckk_BoostedCentral'].Fill(lb_Ckk)
        histograms['h_ld_Cnn_BoostedCentral'].Fill(ld_Cnn)
        histograms['h_ld_Cnr_BoostedCentral'].Fill(ld_Cnr)
        histograms['h_ld_Cnk_BoostedCentral'].Fill(ld_Cnk)
        histograms['h_ld_Crn_BoostedCentral'].Fill(ld_Crn)
        histograms['h_ld_Crr_BoostedCentral'].Fill(ld_Crr)
        histograms['h_ld_Crk_BoostedCentral'].Fill(ld_Crk)
        histograms['h_ld_Ckn_BoostedCentral'].Fill(ld_Ckn)
        histograms['h_ld_Ckr_BoostedCentral'].Fill(ld_Ckr)
        histograms['h_ld_Ckk_BoostedCentral'].Fill(ld_Ckk)
